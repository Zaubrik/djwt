...
const __exp = __instantiate("file:///Users/agalushka/go/src/gitlab.ecsvc.net/edgecompute/djwt/create", false);
export const makeJwt = __exp["makeJwt"];
export const setExpiration = __exp["setExpiration"];
export const makeSignature = __exp["makeSignature"];
export const convertHexToBase64url = __exp["convertHexToBase64url"];
export const convertStringToBase64url = __exp["convertStringToBase64url"];
export const Payload = __exp["Payload"];
export const Jose = __exp["Jose"];
export const JwtInput = __exp["JwtInput"];
export const JsonValue = __exp["JsonValue"];
